...
* *1 hour* Meeting with supervisor - minutes initially recorded on notion.

### 22 Sep 2023

* *1.5 hours* PAL training - took notes on notion for initial 'big picture' research into factors that impact student engagement & got some contacts in SLD to further discuss with later on

## Week 2

### 27 Sep 2023 - Storm impact forced me to work from home, so I got BUSY on wednesday

* *0.5 hour* Went over the marking scheme and highlighted problem areas for me. Notes added to notion on this.
* *0.5 hour* Fixed the repository on GitHub & screamed into the void.
* *1 hour* Created rough initial timeframe and plan for project for next supervisor meeting.
